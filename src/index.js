...
function getReplaceFunc({ transformImportPath, replaceHandlerName = 'default', resolveFrom = 'process.cwd()' } = {}) {
    const absolutePath = resolve(eval(resolveFrom), transformImportPath);
